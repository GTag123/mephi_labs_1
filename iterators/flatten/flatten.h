...
//        prefixsum_.push_back(0); // префиксамы делаем в главном классе иначе не пройдёт по времени ну и просто это логичнее
//        for (int i = 1; i < (int) data_.size() + 1; ++i) {
//            prefixsum_.push_back(prefixsum_[(int)prefixsum_.size() - 1] + (int) data_[i-1].size());
//        }
//    };
////    ~FlatIter(){
////        delete &prefixsum_;
...
//        }
//        FlatIter<T> ret = FlatIter<T>(this->data_, this->pos_ + value);
...
//            return FlatIter(this->data_, 0);
//        }
//        return FlatIter<T>(this->data_, this->pos_ - value);
//    }
...
////    }
//    FlatIter<T> begin() {
//        return FlatIter<T>(vec_, 0);
//    }
//    FlatIter<T> end() {
//        return FlatIter<T>(vec_, this->begin().end());
//    }
//
//private:
